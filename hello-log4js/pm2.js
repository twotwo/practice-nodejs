...
log4js.configure({
  appenders: {
    out: { type: "file", filename: "log/pm2logs.log" }
  },
  categories: {
...
console.info("I'm forever blowing bubbles -console", process.env.INSTANCE_ID)
...
setTimeout(() => {
  log4js.shutdown(() => {
    console.error("All done, shutdown cb returned.", process.env.INSTANCE_ID)
  })
}, 5000)
